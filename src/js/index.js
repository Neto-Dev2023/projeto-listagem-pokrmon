/*
objetivo 1 -quando clicar no botão de troca de tema, adicionar a classe modo escurono body para que os estilos do modo escuro sejam aplicados e mudar a imgem lua
   - passo 1 - pegar no JS o elemento HTML correspondente ao botão de troca de tema
   - passo 2 - dar um jeito de pegar no JS o elemento HTML correpondente ao body
   - passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
   tema
   - passo 4 - adicionar a classe modo-escuro no body
   - passo 5 - trocar a imagem no botão de alterar tema pra lua
